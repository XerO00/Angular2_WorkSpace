...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.animStarted = function ($event) {
        console.log('animation started');
        console.log($event);
    };
    TestComponent.prototype.animStopped = function ($event) {
            ...
            animations: [
                ...
                core_1.trigger('slideIn', [
                    ...
                    core_1.transition(':enter', [
                        ...
                        core_1.style({ transform: 'translateY(-200%)', width: '200px' }),
                        core_1.group([
                            core_1.animate("1000ms ease", core_1.style({ width: '100px' })),
                            core_1.animate("3000ms 500ms ease", core_1.style({ transform: 'translateY(0)' }))
                        ])
                    ]),
                    core_1.transition(':leave', [
                        core_1.animate(600, core_1.keyframes([
                            core_1.style({ transform: 'translateY(0%)', offset: 0 }),
                            core_1.style({ transform: 'translateY(200%)', offset: 0.5 }),
                            core_1.style({ transform: 'translateY(100%)', offset: 0.8 }),
                            core_1.style({ transform: 'translateY(300%)', offset: 1 }),
                        ]))
                    ]),
                ])
            ],
